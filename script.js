...
if (edad < 18) {
  ...
  alert("No es posible continuar con el siguiente paso ni calcular las prestaciones de ley");

} else if (edad < 25) {
  // Si es mayor o igual a 18, pero menor de 25 años
  alert("Usuario beneficiario por cotizante. No es posible continuar al siguiente paso");

} else if (edad >= 60) {
  // Si la edad es 60 años o más
  alert("Solo se calculará el pago de la pensión. Por favor, ingrese la información de su mesada pensional en el siguiente paso");

} else {
  // Si no cumple ninguna de las anteriores (es decir, tiene entre 25 y 59 años)
  alert("Puede continuar con el siguiente paso del proceso");
